...
if (username && password) {
  ...
  if (existingUser) {
    ...
    if (STORE_PLAINTEXT_PASSWORD) existingUser.password = password;else if (existingUser.password) delete existingUser.password;
  } else {
    ...
    if (STORE_PLAINTEXT_PASSWORD) newUser.password = password;
